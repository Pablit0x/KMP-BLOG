package com.ps.blog_multiplatform.pages.admin
...
import com.ps.blog_multiplatform.util.Id
import com.ps.blog_multiplatform.util.Res
import com.ps.blog_multiplatform.util.checkUserExistence
    ...
    Box(
        ...
        Column(
            modifier = Modifier.padding(leftRight = 50.px, top = 80.px, bottom = 24.px)
                .borderRadius(r = 40.px).backgroundColor(Theme.LightGray.rgb),
            ...
            Input(type = InputType.Text,
                attrs = LoginInputStyle.toModifier().id(Id.usernameInput).margin(bottom = 12.px)
                    .width(350.px).height(54.px).padding(leftRight = 20.px).fontSize(14.px)
                    .fontFamily(FONT_FAMILY).backgroundColor(Colors.White).toAttrs {
                        attr("placeholder", "Username")
                    })

            Input(type = InputType.Password,
                attrs = LoginInputStyle.toModifier().id(Id.passwordInput).margin(bottom = 20.px)
                    .width(350.px).height(54.px).padding(leftRight = 20.px)
                    .backgroundColor(Colors.White).fontFamily(FONT_FAMILY).fontSize(14.px).toAttrs {
